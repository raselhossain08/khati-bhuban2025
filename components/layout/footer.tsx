          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center space-x-3 mb-4">
              <div className="flex flex-col">
                ...
                <span className="text-sm font-bengali text-amber-200">
                  খাঁটি ভুবন
                </span>
              </div>
            </Link>
            {language === "en" ? (
              <p className="text-slate-300 mb-6 leading-relaxed">
                Experience the pure taste of nature. 100% raw, unadulterated
                honey straight from the heart of Bhuban&apos;s forests.
                Guaranteed purity, guaranteed goodness.
              </p>
            ) : (
              <p className="text-slate-300 font-bengali mb-6 leading-relaxed">
                প্রকৃতির খাঁটি স্বাদের অভিজ্ঞতা নিন। ভুবনের অরণ্যের গভীর থেকে
                সরাসরি আপনার বাড়িতে। গ্যারান্টিড খাঁটি। গ্যারান্টিড উপকারিতা।
              </p>
            )}
              ...
              <ul className="space-y-3">
                {section.links.map((link) => (
                  <li key={link.name}>
                    ...
                    >
                      <span className={language === "bn" ? "font-bengali" : ""}>
                        {language === "en" ? link.name : link.nameBn}
                      </span>
                    </Link>
                  </li>
                ))}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0">
            ...
            >
              {language === "en"
                ...
                : "© ২০২৪ খাঁটি ভুবন। সমস্ত অধিকার সংরক্ষিত।"}
            </p>
